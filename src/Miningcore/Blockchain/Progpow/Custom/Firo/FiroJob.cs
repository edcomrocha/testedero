        ...
        if(coin.HasFounderFee)
        {
            ...
            if(network.Name.ToLower() == "testnet")
                founders = new[]
                {
                    new Founder
                    {
                        Payee = "TWDxLLKsFp6qcV1LL4U2uNmW4HwMcapmMU",
                        Amount = 93750000
                    },
                    new Founder
                    {
                        Payee = "TCkC4uoErEyCB4MK3d6ouyJELoXnuyqe9L",
                        Amount = 62500000
                    }
                };
            else
                founders = new[]
                {
                    new Founder
                    {
                        Payee = "aLgRaYSFk6iVw2FqY1oei8Tdn2aTsGPVmP",
                        Amount = 93750000
                    },
                    new Founder
                    {
                        Payee = "aFA2TbqG9cnhhzX5Yny2pBJRK5EaEqLCH7",
                        Amount = 62500000
                    }
                };
