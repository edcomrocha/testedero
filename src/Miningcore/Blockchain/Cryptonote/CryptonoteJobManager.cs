...
public class CryptonoteJobManager : JobManagerBase<CryptonoteJob>
{
    ...
    {
        var response = await rpc.ExecuteAsync<SubmitResponse>(logger, CryptonoteCommands.SubmitBlock, CancellationToken.None, new[]
        {
            blobHex
        });
    ...
    public CryptonoteCoinTemplate Coin { get; private set; }
