...
public class BeamPool : PoolBase
{
    ...
    protected virtual async Task OnSubmitAsync(StratumConnection connection, Timestamped<JsonRpcRequest> tsRequest, CancellationToken ct)
    {
        ...
        try
        {
            ...
            if(stratumError == BeamConstants.BeamRpcLowDifficultyShare)
            {
                // response
            ...
            if(stratumError == BeamConstants.BeamRpcShareBadNonce)
            {
                // response
            ...
            if(stratumError == BeamConstants.BeamRpcShareBadSolution)
            {
                // response
            ...
            if(stratumError == BeamConstants.BeamRpcDuplicateShare)
            {
                // response
            ...
            if(stratumError == BeamConstants.BeamRpcJobNotFound)
            {
                // response
