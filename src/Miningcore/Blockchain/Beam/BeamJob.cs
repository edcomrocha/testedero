...
public class BeamJob
{
        ...
        string solution)
    {
        ...
        var solutionHashValue = new BigInteger(solutionHash, true, true);
        ...
        if(!isBlockCandidate && ratio < 0.99)
        {
            ...
            if(context.VarDiff?.LastUpdate != null && context.PreviousDifficulty.HasValue)
            {
                ...
                if(ratio < 0.99)
                    ...
                    }, null, BeamConstants.BeamRpcLowDifficultyShare);
    ...
    public object[] GetJobParamsForStratum()
    {
        return new object[]
        {
            JobId, BlockTemplate.Height, BlockTemplate.Difficulty, BlockTemplate.PackedDifficulty, BlockTemplate.Input, BlockTemplate.PowType, true
        };
    }
