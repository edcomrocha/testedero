...
public class BitcoinStratumMethods
{
    ...
    /// <summary>
    ///     Basically the idea is that miner remember the last difficulty given by the previous mining session and it sends
    ///     mining.suggest_difficulty(difficulty) on the beginning of the next session (it may be sent before mining.subscribe
    ///     or mining.resume, but it should not be a requirement)
    /// </summary>
