...
#pragma warning restore 618
    ...
    protected virtual Money CreateMasternodeOutputs(Transaction tx, Money reward)
    {
        if(masterNodeParameters.Masternode != null)
        {
            ...
            if(masterNodeParameters.Masternode.Type == JTokenType.Array)
                ...
                masternodes = new[]
                {
                    masterNodeParameters.Masternode.ToObject<Masternode>()
                };
    ...
    protected virtual Money CreateFounderOutputs(Transaction tx, Money reward)
    {
        if(founderParameters.Founder != null)
        {
            ...
            if(founderParameters.Founder.Type == JTokenType.Array)
                ...
                founders = new[]
                {
                    founderParameters.Founder.ToObject<Founder>()
                };
        ...
        IHashAlgorithm headerHasher, IHashAlgorithm blockHasher)
    {
        ...
        Difficulty = new Target(BigInteger.Parse(BlockTemplate.Target, NumberStyles.HexNumber)).Difficulty;
        ...
        {
            JobId, previousBlockHashReversedHex, coinbaseInitialHex, coinbaseFinalHex, merkleBranchesHex, BlockTemplate.Version.ToStringHex8(), BlockTemplate.Bits, BlockTemplate.CurTime.ToStringHex8(), false
        };
    }
