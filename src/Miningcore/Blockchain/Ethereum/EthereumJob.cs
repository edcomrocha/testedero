...
public class EthereumJob
{
    ...
    public object[] GetJobParamsForStratum()
    {
        return new object[]
        {
            Id, BlockTemplate.Seed.StripHexPrefix(), BlockTemplate.Header.StripHexPrefix(), true
        };
    }
    ...
    public object[] GetWorkParamsForStratum(EthereumWorkerContext context)
    {
        ...
        return new object[]
        {
            BlockTemplate.Header, BlockTemplate.Seed, workerTargetString
        };
    }
