...
public class EthereumPoolConfigExtra
{
    ...
    /// <summary>
    ///     There are several reports of bad actors taking advantage of the old "Ethash Stratum V1" protocol in order to
    ///     perform multiple dangerous attacks like man-in-the-middle (MITM) attacks
    ...
    ///     Based on that critical fact, mining pool should be cautious of the risks of using a such deprecated and broken
    ///     stratum protocol. Used it at your own risks.
