...
public partial class BitcoinTemplate : CoinTemplate
{
    ...
    [JsonProperty(DefaultValueHandling = DefaultValueHandling.Ignore)]
    public bool HasBrokenSendMany { get; set; }
...
{
    /// <summary>
    ///     Enable for client IP addresses to be detected when using a load balancer with TCP proxy protocol enabled, such as
    ///     HAProxy.
    /// </summary>
...
public partial class PoolConfig
{
    ...
    /// <summary>
    ///     Interval in seconds for performing sweeps over connected miners operating on a too high diff to submit shares and
    ///     adjust varDiff down
    /// </summary>
