...
public unsafe class ScryptN : IHashAlgorithm
{
    ...
    {
        Tuple.Create(2048L, 1389306217L), Tuple.Create(4096L, 1456415081L), Tuple.Create(8192L, 1506746729L), Tuple.Create(16384L, 1557078377L), Tuple.Create(32768L, 1657741673L), Tuple.Create(65536L, 1859068265L), Tuple.Create(131072L, 2060394857L), Tuple.Create(262144L, 1722307603L), Tuple.Create(524288L, 1769642992L)
