...
public class EtchashLight : IEthashLight
{
    ...
    {
        var epochLength = block >= hardForkBlock ? EthereumClassicConstants.EpochLength : EthereumConstants.EpochLength;
...
#pragma warning disable 4014
                future.GenerateAsync(logger, epochLength, hardForkBlock, ct);
#pragma warning restore 4014
        ...
        await result.GenerateAsync(logger, epochLength, hardForkBlock, ct);
